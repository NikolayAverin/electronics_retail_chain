...
from retail_chain.views import (ContactViewSet, HierarchyElementViewSet,
                                ProductViewSet)
...
hierarchy_element_router.register(
    "hierarchy-elements", HierarchyElementViewSet, basename="hierarchy-elements"
)
